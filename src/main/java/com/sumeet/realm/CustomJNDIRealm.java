...
public class CustomJNDIRealm extends RealmBase {
     ...
     * {@link #} will be used if specified, else an anonymous
     ...
     * set using {@link CustomJNDIRealm#setSslProtocol(String) setSslProtocol(String)}.
     *
     ...
     * {@link #} if specified or an anonymous connection if
    ...
    protected Hashtable<String,String> getDirectoryContextEnvironment() {
        ...
        if (derefAliases != null)
            env.put(CustomJNDIRealm.DEREF_ALIASES, derefAliases);
